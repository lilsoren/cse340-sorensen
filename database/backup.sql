...
-- Test case for adding review to table
INSERT INTO public.review (account_id, inv_id, review_text)
VALUES 
    (10, 1, 'The Batmobile is an incredible vehicle with amazing features. Love the idea of switching to bike mode for maneuvering through traffic.'),
    (18, 2, 'The Chevy Camaro is fast and fun to drive! I really like the sleek design and smooth ride. Would highly recommend it.');
